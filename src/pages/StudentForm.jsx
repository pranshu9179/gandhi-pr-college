...
// // // //             <div className={`px-4 py-2 rounded-full text-sm font-semibold ${step === 1 ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-600"}`}>
// // // //               Step 1: Personal Details
// // // //             </div>
// // // //             <div className={`px-4 py-2 rounded-full text-sm font-semibold ${step === 2 ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-600"}`}>
// // // //               Step 2: Fees Details
// // // //             </div>
// // // //           </div>
// // // //         </div>
...
// // //                 <div
// // //                   key={index}
// // //                   className="flex items-center gap-2 w-auto bg-gray-50 rounded-xl p-3 "
// // //                 >
// // //                   {/* Label */}
...
// // //                     name={field}
// // //                     onChange={handleChange}
// // //                     className="flex-1 p-3 border rounded-lg bg-white focus:ring-2 focus:ring-blue-400 outline-none"
// // //                     placeholder="Enter amount"
// // //                   />
// // //                 </div>
// // //               ))}
...
// // //         {/* STEP 2 UI */}
// // //         {step === 2 && (
// // //           <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-73 pl-36">
...
// // //                 <div
// // //                   key={index}
// // //                   className="flex justify-between items-center w-full bg-gray-50  rounded-xl px-4 py-3"
// // //                 >
// // //                   {/* FULL-WIDTH LABEL */}
...
// // //                   {/* SMALL INPUT FIELD (Default value 0 & min value 0) */}
// // //                   <input
// // //                     type="number"
// // //                     name={field}
// // //                     min={0}
// // //                     defaultValue={0}
// // //                     onChange={handleChange}
// // //                     className="w-38 p-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-400 outline-none text-center"
// // //                     placeholder="0"
// // //                   />
// // //                 </div>
// // //               ))}
...
// // //               <button
// // //                 onClick={() => setStep(2)}
// // //                 className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold text-right"
// // //               >
// // //                 Next →
// // //               </button>
// // //             </div>
...
// //     enrollment: 0,
// //     others: 0,
// //     total: 0, // ➤ NEW FIELD ADDED
// //   });

// //   const handleChange = (e) =>
// //     setFormData({ ...formData, [e.target.name]: e.target.value });

// //   // 🧮 AUTO CALCULATE TOTAL — ADDED
// //   useEffect(() => {
...
// //               {/* 🔥 TOTAL FIELD ADDED BELOW — No UI style change */}
// //               <div
// //                 className="
// //                   flex 
// //                   flex-col sm:flex-row
